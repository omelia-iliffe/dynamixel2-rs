	...
	Buffer: AsRef<[u8]> + AsMut<[u8]>,
{
	...
	///
	/// The complete blocks that arrived are returned, and the first motor that did not reply is identified
	/// while iterating. Per-motor error fields are checked there too, not here.
	///
